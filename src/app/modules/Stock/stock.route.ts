...
import { StockZodValidations } from "./stock.validation";
...
router.post(
  "/",
  validateRequest(StockZodValidations.createStockZodSchema),
...
router.patch(
  "/:id",
  validateRequest(StockZodValidations.updateStockZodSchema),
